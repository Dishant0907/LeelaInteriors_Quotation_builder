...
export const SparklesIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 3.285 18 4.25l-.259-.965a1.5 1.5 0 0 0-1.032-1.032L15.75 2l.965.259a1.5 1.5 0 0 0 1.032 1.032L18 4.25l.259-.965a1.5 1.5 0 0 0 1.032-1.032L20.25 2l-.965.259a1.5 1.5 0 0 0-1.032 1.032ZM19.759 16.285 19.5 17.25l-.259-.965a1.5 1.5 0 0 0-1.032-1.032L17.25 15l.965.259a1.5 1.5 0 0 0 1.032 1.032L19.5 17.25l.259-.965a1.5 1.5 0 0 0 1.032-1.032L21.75 15l-.965.259a1.5 1.5 0 0 0-1.032 1.032Z" />
  </svg>
);
